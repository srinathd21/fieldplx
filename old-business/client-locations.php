...
<head>
    ...
    <title>Client Locations - FieldPlx</title>
        ...
        <main class="fieldplx-main-content">
            <div class="fieldplx-content-wrapper">
                <div class="fd-dashboard">
                    ...
                    <section class="fd-loc-head">
                        <div>
                            <h1 class="fd-loc-title">Client Locations</h1>
                            <p class="fd-loc-sub">
                                Manage multiple service locations for this client, including address, GPS, site contact, access details and service instructions.
                            </p>
                        </div>

                        <div class="fd-loc-actions">
                            <a href="clients.php" class="fd-team-button">
                                <i class="bi bi-arrow-left"></i>
                                Back to Clients
                            </a>

                            <a href="#" class="fd-team-button" id="viewClientButton">
                                <i class="bi bi-eye"></i>
                                View Client
                            </a>

                            <button type="button" class="fd-team-button primary" id="addLocationButton">
                    ...
                    <div class="fd-loc-client">
                        <span class="fd-loc-client-icon">
                            <i class="bi bi-person-vcard"></i>
                        </span>

                        <div>
                            <strong id="clientName">Loading client...</strong>
                            <small id="clientContact">Please wait</small>
                        </div>
                    </div>

                    <section class="fd-card fd-teams-card">
                        <div class="fd-loc-table-wrap">
                            <table class="fd-team-table fd-loc-table" style="min-width:1180px">
                                <thead>
                                    <tr>
                                        <th>S/No</th>
                                        <th>Location</th>
                                ...
                                <tbody id="locationsBody">
                                    <tr>
                                        <td colspan="9" class="fd-team-empty">
                                            Loading locations...
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="fd-team-modal-backdrop" id="locationModal" aria-hidden="true">
                    <section class="fd-team-modal fd-loc-modal" role="dialog" aria-modal="true">
                        <div class="fd-team-modal-header">
                            <span class="fd-team-modal-icon">
                                <i class="bi bi-geo-alt"></i>
                            </span>

                            <div class="fd-team-modal-heading">
                                <h3 id="locationModalTitle">Add Location</h3>
                                <p>Save a service location for this client.</p>
                            </div>

                            <button type="button" class="fd-team-modal-close" id="locationModalClose">
                        ...
                        <form id="locationForm">
                                ...
                                <div class="fd-team-form-grid">
                                    ...
                                    <div class="fd-team-field">
                                        ...
                                        <input
                                            ...
                                            maxlength="190"
                                            required
                                            placeholder="Home / Head Office / Site 1"
                                        >
                                    </div>

                                    <div class="fd-team-field">
                                        <label>Location Type</label>
                                        <select name="location_type" id="locationType">
                                    ...
                                    <div class="fd-team-field full">
                                        ...
                                        <input name="address_line1" id="address1" maxlength="255" required>
                                    </div>

                                    <div class="fd-team-field full">
                                        <label>Address Line 2</label>
                                        <input name="address_line2" id="address2" maxlength="255">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>City</label>
                                        <input name="city" id="city" maxlength="120">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>State</label>
                                        <input name="state" id="state" maxlength="120">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>Postal Code</label>
                                        <input name="postal_code" id="postalCode" maxlength="40">
                                    </div>
                                    ...
                                    <div class="fd-team-field">
                                        ...
                                        <input name="contact_name" id="contactName" maxlength="190">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>Contact Phone</label>
                                        <input name="contact_phone" id="contactPhone" maxlength="50">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>Gate / Access Code</label>
                                        <input name="gate_code" id="gateCode" maxlength="80">
                                    </div>

                                    <div class="fd-team-field">
                                        <label>Status</label>
                                        <select name="status" id="locationStatus">
                                    ...
                                    <div class="fd-team-field full">
                                        ...
                                        <textarea name="access_notes" id="accessNotes"></textarea>
                                    </div>

                                    <div class="fd-team-field full">
                                        <label>Service Instructions</label>
                                        <textarea name="service_instructions" id="serviceInstructions"></textarea>
                                    </div>

                                    <div class="fd-client-checks">
                                        <label class="fd-client-check">
                            ...
                            <div class="fd-team-modal-footer">
                                <button type="button" class="fd-team-button" id="cancelLocationButton">
                                    Cancel
                                </button>

                                <button type="submit" class="fd-team-button primary" id="saveLocationButton">
                                    <span class="fd-team-loader"></span>
                ...
                <div class="fd-team-toast info" id="locationsToast">
                    <span class="fd-team-toast-message" id="locationsToastMessage">
                        Notification
                    </span>

                    <button type="button" class="fd-team-toast-close" id="locationsToastClose">
                        <i class="bi bi-x"></i>
                    </button>
                </div>
                ...
                var toast = document.getElementById('locationsToast');
                var toastMsg = document.getElementById('locationsToastMessage');
                var timer = null;
                ...
                function countries(rows){
                    ...
                    document.getElementById('countryId').innerHTML = html;
                }

                function render(rows){
                    if(!rows.length){
                        body.innerHTML =
                            '<tr><td colspan="9" class="fd-team-empty">'+
                            'No locations found. Add the first service location for this client.'+
                            '</td></tr>';
                        return;
                    }
                    ...
                    rows.forEach(function(x,index){
                        ...
                        if(x.latitude && x.longitude){
                            gps =
                                '<a class="fd-loc-map-link" target="_blank" rel="noopener" href="https://www.google.com/maps?q='+
                                encodeURIComponent(x.latitude+','+x.longitude)+
                                '">'+
                                esc(x.latitude)+', '+esc(x.longitude)+
                                '</a>';
                        }
                        ...
                        html +=
                            '<tr>'+
                                ...
                                '<td><span class="fd-client-badge default">'+esc(x.location_type)+'</span></td>'+
                                '<td class="fd-loc-address">'+esc(address || '-')+'</td>'+
                                '<td>'+esc(x.contact_name || '-')+'<br><small>'+esc(x.contact_phone || '-')+'</small></td>'+
                                '<td>'+gps+'</td>'+
                                '<td>'+(Number(x.is_primary)===1 ? '<span class="fd-client-badge active">Primary</span>' : '-')+'</td>'+
                                '<td><span class="fd-client-badge '+esc(x.status)+'">'+esc(x.status)+'</span></td>'+
                                '<td>'+
                                    '<div class="fd-team-actions-cell">'+
                                        '<button type="button" class="fd-team-icon-button" data-action="edit" data-id="'+Number(x.id)+'" title="Edit Location"><i class="bi bi-pencil"></i></button>'+
                                        '<button type="button" class="fd-team-icon-button danger" data-action="archive" data-id="'+Number(x.id)+'" title="Archive Location"><i class="bi bi-archive"></i></button>'+
                                    '</div>'+
                                '</td>'+
                            '</tr>';
                    });
                ...
                function load(){
                    ...
                    document.getElementById('viewClientButton').href =
                        'client-view.php?client_id=' + clientId;
                ...
                function openLocation(id){
                    ...
                    if(id <= 0){
                        ...
                        document.getElementById('saveLocationText').textContent =
                            'Save Location';
                    ...
                    request(fd)
                        .then(function(data){
                            ...
                            document.getElementById('locationId').value = x.id || 0;
                            document.getElementById('locationName').value = x.name || '';
                            document.getElementById('locationType').value = x.location_type || 'other';
                            document.getElementById('address1').value = x.address_line1 || '';
                            document.getElementById('address2').value = x.address_line2 || '';
                            document.getElementById('city').value = x.city || '';
                            document.getElementById('state').value = x.state || '';
                            document.getElementById('postalCode').value = x.postal_code || '';
                            document.getElementById('countryId').value = x.country_id || '';
                            document.getElementById('latitude').value = x.latitude || '';
                            document.getElementById('longitude').value = x.longitude || '';
                            document.getElementById('contactName').value = x.contact_name || '';
                            document.getElementById('contactPhone').value = x.contact_phone || '';
                            document.getElementById('gateCode').value = x.gate_code || '';
                            document.getElementById('locationStatus').value = x.status || 'active';
                            document.getElementById('accessNotes').value = x.access_notes || '';
                            document.getElementById('serviceInstructions').value = x.service_instructions || '';
                ...
                form.addEventListener('submit',function(event){
                    ...
                    var button =
                        document.getElementById('saveLocationButton');
                ...
                body.addEventListener('click',function(event){
                    ...
                    if(button.dataset.action === 'archive'){
                        ...
                        fd.append('location_id',button.dataset.id);
                ...
                document.getElementById('locationModalClose').onclick = function(){
                    modal.classList.remove('show');
                };

                document.getElementById('cancelLocationButton').onclick = function(){
                    modal.classList.remove('show');
                };

                document.getElementById('locationsToastClose').onclick = function(){
                    toast.classList.remove('show');
                };
