...
.fp-sidebar-body {
    ...
    scrollbar-color:
        rgba(243, 242, 246, 0.81) rgba(255, 255, 255, .05);
}
        ...
        <nav>
            ...
            <div class="fp-sidebar-menu <?= fpMenuOpen($tenantMenuPages, $activePage); ?>">
                ...
                <div class="fp-sidebar-submenu">
                    <a href="tenants.php" class="fp-sidebar-sublink <?= fpActive('tenants', $activePage); ?>">All
                        Tenants</a>
                    <a href="tenant-add.php" class="fp-sidebar-sublink <?= fpActive('tenant-add', $activePage); ?>">Add
                        Tenant</a>
            ...
            <a href="platform-users.php" class="fp-sidebar-link">
