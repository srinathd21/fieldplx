...
/* Quotations - canonical tenant UI */
a,a:link,a:visited,a:hover,a:focus,a:active{text-decoration:none!important}
.fq-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:18px}.fq-title{margin:0 0 7px;color:var(--fd-text);font-size:21px;font-weight:700}.fq-sub{margin:0;max-width:880px;color:var(--fd-muted);font-size:10.5px;line-height:1.55}.fq-actions{display:flex;gap:8px;flex-wrap:wrap}.fq-btn{min-height:39px;padding:0 13px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid var(--fd-border);border-radius:8px;color:#43546c;background:#fff;font-size:10px;font-weight:700;cursor:pointer}.fq-btn.primary{border-color:var(--fd-green);color:#fff;background:linear-gradient(90deg,#7fc92d,#68aa1d);box-shadow:0 7px 16px rgba(104,170,29,.16)}.fq-btn:hover{border-color:#cfe3ae;color:var(--fd-green-dark);background:#f9fcf4}.fq-btn.primary:hover{color:#fff;background:linear-gradient(90deg,#74b824,#5d971b)}
.fq-summary{margin-bottom:16px}.fq-stat{min-height:112px;padding:18px 20px;border:1px solid #dfe6ef;border-radius:12px;background:#fff;box-shadow:0 3px 12px rgba(24,45,76,.035)}.fq-stat-row{min-height:72px;display:flex;align-items:center;gap:18px}.fq-stat-icon{width:58px;height:58px;flex:0 0 58px;display:grid;place-items:center;border-radius:16px;background:#123f73;color:#fff;font-size:25px}.fq-stat-label{display:block;margin-bottom:8px;color:#506784;font-size:13px}.fq-stat-value{display:block;color:#020b16;font-size:31px;line-height:1;font-weight:700}
.fq-card{overflow:hidden}.fq-toolbar{padding:13px 14px;display:flex;align-items:center;gap:8px;flex-wrap:wrap;border-bottom:1px solid var(--fd-border);background:#fbfcfd}.fq-search{width:270px;position:relative}.fq-search i{position:absolute;left:12px;top:50%;transform:translateY(-50%);color:#8a96a7;font-size:13px}.fq-search input,.fq-filter{height:39px;border:1px solid #dde4ec;border-radius:8px;outline:0;color:#33445f;background:#fff;font-size:10px}.fq-search input{width:100%;padding:8px 11px 8px 34px}.fq-filter{min-width:145px;padding:8px 10px}.fq-spacer{margin-left:auto}.fq-search input:focus,.fq-filter:focus{border-color:#a9cf75;box-shadow:0 0 0 3px rgba(116,184,36,.11)}
.fq-table-wrap{width:100%;overflow-x:auto;overflow-y:hidden;scrollbar-width:thin;scrollbar-color:#9aa0a6 transparent}.fq-table-wrap::-webkit-scrollbar{height:3px!important}.fq-table-wrap::-webkit-scrollbar-track{background:transparent!important}.fq-table-wrap::-webkit-scrollbar-thumb{min-width:20px;border-radius:999px!important;background:#9aa0a6!important}.fq-table-wrap::-webkit-scrollbar-button{display:none!important;width:0!important;height:0!important}.fq-table{width:100%;min-width:1260px;border-collapse:collapse;white-space:nowrap}.fq-table th{padding:11px 12px;border-bottom:1px solid var(--fd-border);color:#65738a;background:#f8fafc;font-size:9px;font-weight:700;text-align:left;text-transform:uppercase}.fq-table td{padding:12px;border-bottom:1px solid #f1f3f7;color:#33445f;font-size:9.5px;vertical-align:middle}.fq-table tbody tr:hover{background:#fbfcfa}.fq-main strong,.fq-main small,.fq-client strong,.fq-client small{display:block}.fq-main strong{color:#123d70;font-size:10.5px}.fq-main small,.fq-client small{margin-top:3px;color:#8995a6;font-size:8.3px}.fq-client strong{color:#17233b;font-size:10px}.fq-badge{min-height:22px;padding:4px 7px;display:inline-flex;align-items:center;justify-content:center;border-radius:5px;font-size:8.3px;font-weight:700;text-transform:capitalize}.fq-badge.draft{color:#123d70;background:#edf2f7}.fq-badge.internal_approval,.fq-badge.sent,.fq-badge.viewed{color:#8a5e10;background:#fff7df}.fq-badge.approved,.fq-badge.converted{color:#5d971b;background:#f0f8e5}.fq-badge.rejected,.fq-badge.expired,.fq-badge.archived{color:#bd2f3a;background:#fff0f1}.fq-badge.changes_requested{color:#5b4dad;background:#f1efff}.fq-row-actions{display:flex;align-items:center;gap:4px}.fq-icon{width:29px;height:29px;display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:6px;color:#66748b;background:transparent;cursor:pointer}.fq-icon:hover{color:var(--fd-green-dark);background:var(--fd-green-soft)}.fq-empty{padding:28px 18px!important;text-align:center;color:#9aa4b3!important;font-size:10px!important}.fq-pagination{min-height:49px;padding:10px 14px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-top:1px solid var(--fd-border);color:#768397;background:#fff;font-size:9px}.fq-pagination-actions{display:flex;gap:5px}.fq-toast{width:min(300px,calc(100vw - 24px));position:fixed;top:82px;right:16px;z-index:25000;padding:8px 9px;display:flex;align-items:center;gap:7px;border-radius:7px;color:#fff;box-shadow:0 10px 26px rgba(0,17,49,.18);opacity:0;transform:translateY(-8px);pointer-events:none;transition:.18s}.fq-toast.show{opacity:1;transform:translateY(0)}.fq-toast.error{background:#e45b66}.fq-toast.success{background:#5d971b}.fq-toast.info{background:#123d70}.fq-toast span{flex:1;font-size:8.5px;font-weight:600}
@media(max-width:767.98px){.fq-head{flex-direction:column}.fq-actions{width:100%}.fq-actions .fq-btn{flex:1}.fq-search{width:100%}.fq-spacer{display:none}.fq-filter{flex:1}}@media(max-width:575.98px){.fq-toast{top:72px;left:12px;right:12px;width:auto}}
</style>
</head>
<body>
    ...
    <main class="fieldplx-main-content">
        <div class="fieldplx-content-wrapper">
            <div class="fd-dashboard">
                <section class="fq-head">
                    <div><h1 class="fq-title">Quotations</h1><p class="fq-sub">Create and manage customer quotations linked to service enquiries. Amounts and symbols follow the tenant currency configuration.</p></div>
                    <div class="fq-actions"><button type="button" class="fq-btn" id="refreshButton"><i class="bi bi-arrow-clockwise"></i> Refresh</button><a class="fq-btn primary" href="add-quotation.php"><i class="bi bi-plus-lg"></i> Add Quotation</a></div>
                </section>
                <section class="row g-3 fq-summary">
                    <div class="col-xl-3 col-6"><article class="fq-stat"><div class="fq-stat-row"><span class="fq-stat-icon"><i class="bi bi-receipt"></i></span><div><span class="fq-stat-label">Total Quotes</span><strong class="fq-stat-value" id="statTotal">0</strong></div></div></article></div>
                    <div class="col-xl-3 col-6"><article class="fq-stat"><div class="fq-stat-row"><span class="fq-stat-icon"><i class="bi bi-pencil-square"></i></span><div><span class="fq-stat-label">Draft</span><strong class="fq-stat-value" id="statDraft">0</strong></div></div></article></div>
                    <div class="col-xl-3 col-6"><article class="fq-stat"><div class="fq-stat-row"><span class="fq-stat-icon"><i class="bi bi-send"></i></span><div><span class="fq-stat-label">Sent / Viewed</span><strong class="fq-stat-value" id="statSent">0</strong></div></div></article></div>
                    <div class="col-xl-3 col-6"><article class="fq-stat"><div class="fq-stat-row"><span class="fq-stat-icon"><i class="bi bi-check2-circle"></i></span><div><span class="fq-stat-label">Approved</span><strong class="fq-stat-value" id="statApproved">0</strong></div></div></article></div>
                </section>
                <section class="fd-card fq-card">
                    <div class="fq-toolbar">
                        <div class="fq-search"><i class="bi bi-search"></i><input type="search" id="search" placeholder="Search quote, enquiry or customer"></div>
                        <select class="fq-filter" id="statusFilter"><option value="">All Status</option><option value="draft">Draft</option><option value="internal_approval">Internal Approval</option><option value="sent">Sent</option><option value="viewed">Viewed</option><option value="changes_requested">Changes Requested</option><option value="approved">Approved</option><option value="rejected">Rejected</option><option value="expired">Expired</option><option value="converted">Converted</option><option value="archived">Archived</option></select>
                        <input class="fq-filter" type="date" id="fromDate" title="From Date"><input class="fq-filter" type="date" id="toDate" title="To Date">
                        <button type="button" class="fq-btn" id="clearFilters"><i class="bi bi-x-circle"></i> Clear</button><span class="fq-spacer"></span>
                        <select class="fq-filter" id="perPage"><option value="10">10 / page</option><option value="25">25 / page</option><option value="50">50 / page</option></select>
                    </div>
                    <div class="fq-table-wrap"><table class="fq-table"><thead><tr><th>S.No</th><th>Quotation</th><th>Enquiry</th><th>Customer</th><th>Title</th><th>Date</th><th>Valid Until</th><th>Subtotal</th><th>Tax</th><th>Total</th><th>Status</th><th>Action</th></tr></thead><tbody id="quoteRows"><tr><td colspan="12" class="fq-empty">Loading quotations...</td></tr></tbody></table></div>
                    <div class="fq-pagination"><span id="countText">Showing 0 quotations</span><div class="fq-pagination-actions"><button type="button" class="fq-btn" id="prevPage"><i class="bi bi-chevron-left"></i></button><button type="button" class="fq-btn" id="nextPage"><i class="bi bi-chevron-right"></i></button></div></div>
                </section>
            </div>
        </div>
    </main>
</div>
<div class="fq-toast info" id="toast"><span id="toastMsg">Notification</span></div>
<?php require_once __DIR__ . '/includes/footer.php'; ?>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script>
(function(){'use strict';var csrfToken=<?= json_encode($csrfToken) ?>;var state={page:1,perPage:10,search:'',status:'',from:'',to:''},timer=null,searchTimer=null;var body=document.getElementById('quoteRows'),toast=document.getElementById('toast'),toastMsg=document.getElementById('toastMsg');function esc(v){return String(v==null?'':v).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;').replace(/'/g,'&#039;')}function title(v){return String(v||'-').replace(/_/g,' ').replace(/\b\w/g,function(x){return x.toUpperCase()})}function notify(t,m){if(timer)clearTimeout(timer);toast.className='fq-toast '+(t||'info')+' show';toastMsg.textContent=m||'Notification';timer=setTimeout(function(){toast.classList.remove('show')},3000)}function parse(r){return r.text().then(function(raw){var d,t=(raw||'').trim();try{d=t?JSON.parse(t):{}}catch(e){throw new Error(t.replace(/<[^>]*>/g,' ').replace(/\s+/g,' ').trim()||'Invalid server response.')}if(!r.ok||!d.success)throw new Error(d.message||'Request failed.');return d})}function req(fd){fd.append('csrf_token',csrfToken);return fetch('api/quotations.php',{method:'POST',body:fd,credentials:'same-origin',headers:{'X-Requested-With':'XMLHttpRequest','Accept':'application/json'}}).then(parse)}function money(n,c){n=Number(n||0);c=c||{};var s=n.toFixed(Number(c.decimal_places||2)),sym=c.symbol||'';return c.symbol_position==='after'?s+(sym?' '+sym:''):(sym||'')+s}function load(){var fd=new FormData();fd.append('action','list');fd.append('page',state.page);fd.append('per_page',state.perPage);fd.append('search',state.search);fd.append('status',state.status);fd.append('from_date',state.from);fd.append('to_date',state.to);body.innerHTML='<tr><td colspan="12" class="fq-empty">Loading quotations...</td></tr>';req(fd).then(function(d){var rows=d.quotations||[],c=d.currency||{},p=d.pagination||{},s=d.summary||{};document.getElementById('statTotal').textContent=Number(s.total||0);document.getElementById('statDraft').textContent=Number(s.draft||0);document.getElementById('statSent').textContent=Number(s.sent_viewed||0);document.getElementById('statApproved').textContent=Number(s.approved||0);if(!rows.length){body.innerHTML='<tr><td colspan="12" class="fq-empty">No quotations found.</td></tr>'}else{var h='';rows.forEach(function(r,i){var edit=['draft','internal_approval','changes_requested'].indexOf(r.status)>=0;h+='<tr><td>'+Number((p.from||1)+i)+'</td><td><div class="fq-main"><strong>'+esc(r.quote_no)+'</strong><small>Revision '+Number(r.revision_no||0)+'</small></div></td><td><div class="fq-main"><strong>'+esc(r.quotation_source||((r.request_no||'')?'Original Enquiry':'Direct Quotation'))+'</strong><small>'+esc(r.request_no||'Direct')+'</small></div></td><td><div class="fq-client"><strong>'+esc(r.client_name||'-')+'</strong><small>'+esc(r.client_phone||'')+'</small></div></td><td>'+esc(r.title||'-')+'</td><td>'+esc(r.created_date||r.created_at||'-')+'</td><td>'+esc(r.valid_until||'-')+'</td><td>'+money(r.subtotal,c)+'</td><td>'+money(r.tax_total,c)+'</td><td><strong>'+money(r.total,c)+'</strong></td><td><span class="fq-badge '+esc(r.status)+'">'+esc(title(r.status))+'</span></td><td><div class="fq-row-actions"><a class="fq-icon" href="view-quotation.php?quote_id='+Number(r.id)" title="View"><i class="bi bi-eye"></i></a>'+(edit?'<a class="fq-icon" href="add-quotation.php?quote_id='+Number(r.id)+'" title="Edit"><i class="bi bi-pencil"></i></a>':'')+'</div></td></tr>'});body.innerHTML=h}document.getElementById('countText').textContent='Showing '+Number(p.from||0)+'-'+Number(p.to||0)+' of '+Number(p.total||0)+' quotations';document.getElementById('prevPage').disabled=state.page<=1;document.getElementById('nextPage').disabled=state.page>=Number(p.pages||1)}).catch(function(e){body.innerHTML='<tr><td colspan="12" class="fq-empty">'+esc(e.message)+'</td></tr>';notify('error',e.message)})}document.getElementById('search').addEventListener('input',function(e){if(searchTimer)clearTimeout(searchTimer);searchTimer=setTimeout(function(){state.search=e.target.value.trim();state.page=1;load()},250)});document.getElementById('statusFilter').onchange=function(e){state.status=e.target.value;state.page=1;load()};document.getElementById('fromDate').onchange=function(e){state.from=e.target.value;state.page=1;load()};document.getElementById('toDate').onchange=function(e){state.to=e.target.value;state.page=1;load()};document.getElementById('perPage').onchange=function(e){state.perPage=Number(e.target.value||10);state.page=1;load()};document.getElementById('clearFilters').onclick=function(){document.getElementById('search').value='';document.getElementById('statusFilter').value='';document.getElementById('fromDate').value='';document.getElementById('toDate').value='';state.search=state.status=state.from=state.to='';state.page=1;load()};document.getElementById('refreshButton').onclick=load;document.getElementById('prevPage').onclick=function(){if(state.page>1){state.page--;load()}};document.getElementById('nextPage').onclick=function(){state.page++;load()};load()})();
</script>
</body></html>
