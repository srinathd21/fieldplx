...
if (empty($_SESSION['teams_csrf_token'])) {
    $_SESSION['teams_csrf_token'] = bin2hex(random_bytes(32));
}

$teamsCsrfToken = (string)$_SESSION['teams_csrf_token'];
?>
            ...
            <div class="fieldplx-content-wrapper">
                <div class="fd-dashboard">
                    ...
                    <section class="fd-teams-header">
                        ...
                        <div>
                            <h1 class="fd-teams-title">Teams</h1>
                            <p class="fd-teams-subtitle">
                                Manage tenant teams, branch and department assignment, team leaders and employee membership.
                            </p>
                        </div>
                        ...
                        <div class="fd-teams-actions">
                            ...
                            <button
                                type="button"
                                class="fd-team-button"
                                id="refreshTeamsButton"
                            >
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="fd-team-stat-card">
                                <div class="fd-team-stat-row">
                                    <span class="fd-team-stat-icon">
                                        <i class="bi bi-people"></i>
                                    </span>
                                    <div>
                                        <span class="fd-team-stat-label">Total Teams</span>
                                        <strong class="fd-team-stat-value" id="statTotal">0</strong>
                                    </div>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="fd-team-stat-card">
                                <div class="fd-team-stat-row">
                                    ...
                                    <div>
                                        <span class="fd-team-stat-label">Active Teams</span>
                                        <strong class="fd-team-stat-value" id="statActive">0</strong>
                                    </div>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="fd-team-stat-card">
                                <div class="fd-team-stat-row">
                                    ...
                                    <div>
                                        <span class="fd-team-stat-label">Team Members</span>
                                        <strong class="fd-team-stat-value" id="statMembers">0</strong>
                                    </div>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="fd-team-stat-card">
                                <div class="fd-team-stat-row">
                                    ...
                                    <div>
                                        <span class="fd-team-stat-label">Branches</span>
                                        <strong class="fd-team-stat-value" id="statBranches">0</strong>
                                    </div>
                                </div>
                            </article>
                        </div>
                ...
                <div
                    class="fd-team-modal-backdrop"
                    id="teamModalBackdrop"
                    aria-hidden="true"
                >
                        ...
                        <form id="teamForm">
                            ...
                            <div class="fd-team-modal-body">
                                ...
                                <div class="fd-team-form-grid">
                                    ...
                                    <div class="fd-team-section-title">
                                        Team Details
                                    </div>
                                    ...
                                    <div class="fd-team-field">
                                        <label for="leaderUserId">Team Leader</label>
                                        <select id="leaderUserId" name="leader_user_id">
                                    ...
                                    <div class="fd-team-members-box">

                                        <div class="fd-team-members-head">
                                            <strong>Select Employees</strong>
                                            <small id="selectedMembersCount">0 selected</small>
                                        </div>

                                        <div
                                            class="fd-team-members-list"
                                            id="teamMembersList"
                                        >
                                            <div class="fd-team-empty">
                                                Loading employees...
                                            </div>
                                        </div>
                ...
                >
                    ...
                    <section
                        class="fd-team-modal fd-team-confirm"
                        role="dialog"
                        aria-modal="true"
                    >
                        ...
                        <div class="fd-team-modal-header">
                            ...
                            <div class="fd-team-modal-heading">
                                <h3>Delete Team</h3>
                                <p>Members will be detached from this team.</p>
                            </div>
                        ...
                        <div class="fd-team-modal-body" id="deleteTeamMessage">
                            Delete this team?
                        </div>
                ...
                <div
                    class="fd-team-toast info"
                    id="teamsToast"
                >
                    <span
                        class="fd-team-toast-message"
                        id="teamsToastMessage"
                    >
                        Notification
                    </span>
                ...
                var teamModal =
                    document.getElementById('teamModalBackdrop');
                ...
                var toast =
                    document.getElementById('teamsToast');

                var toastMessage =
                    document.getElementById('teamsToastMessage');
                ...
                function applyMeta(meta){
                    ...
                    var leader = document.getElementById('leaderUserId');
                    var leaderHtml = '<option value="">No Leader</option>';

                    (state.meta.users || []).forEach(
                        function(user){
                            leaderHtml +=
                                '<option value="' +
                                Number(user.id) +
                                ...
                                '<tr>' +
                                    ...
                                    '<td>' +
                                        '<div class="fd-team-actions-cell">' +
                                            '<button type="button" class="fd-team-icon-button" ' +
                                            ...
                                            '<button type="button" class="fd-team-icon-button danger" ' +
                ...
                function loadTeams(){
                    ...
                    fd.append('department_id',state.departmentId);
                    ...
                    request(fd)
                        .then(function(data){
                            ...
                            document.getElementById('statMembers').textContent =
                                Number(summary.members || 0);

                            document.getElementById('statBranches').textContent =
                                Number(summary.branches || 0);

                            var p =
                                data.pagination || {};

                            document.getElementById('teamsCountText').textContent =
                                'Showing ' +
                                Number(p.from || 0) +
                                '-' +
                                Number(p.to || 0) +
                ...
                function renderMembers(
                    ...
                    state.meta.users.forEach(
                        function(user){
                            ...
                            var primary =
                                Number(member.is_primary) === 1
                                    ? ' checked'
                                    : '';

                            html +=
                                '<div class="fd-team-member-row">' +
                                    '<input type="checkbox" ' +
                                    'class="team-member-check" ' +
                                    'name="member_ids[]" ' +
                                    'value="' +
                                    Number(user.id) +
                                    '"' +
                                    checked +
                                    '>' +
                                    '<span class="fd-team-member-copy">' +
                                        '<strong>' +
                                            esc(user.name) +
                                        '</strong>' +
                                        '<small>' +
                                    ...
                                    'value="' +
                                    esc(member.member_role || '') +
                                    '">' +
                                    '<label class="fd-team-primary-label">' +
                                        '<input type="checkbox" ' +
                                        'class="team-member-primary" ' +
                                        'data-user-id="' +
                                        Number(user.id) +
                                        '"' +
                                        primary +
                ...
                function openTeamModal(teamId){
                    ...
                    if(teamId <= 0){
                        ...
                        document.getElementById('saveTeamButtonText').textContent =
                            'Save Team';
                    ...
                    request(fd)
                        .then(function(data){
                            ...
                            document.getElementById('leaderUserId').value =
                                team.leader_user_id || '';
                ...
                function collectMembers(formData){
                    membersList
                        .querySelectorAll(
                            '.team-member-check:checked'
                        )
                        .forEach(
                            function(box){
                                ...
                                var role =
                                    membersList.querySelector(
                                        '.team-member-role[data-user-id="' +
                                        userId +
                                        '"]'
                                    );
                                ...
                                var primary =
                                    membersList.querySelector(
                                        '.team-member-primary[data-user-id="' +
                                        userId +
                                        '"]'
                                    );
                ...
                function saveTeam(){
                    if(!teamForm.reportValidity()){
                        showToast(
                            'warning',
                            'Complete the required team fields.'
                        );
                        return;
                    }

                    var fd =
                        new FormData(teamForm);
                ...
                function openDeleteModal(
                    ...
                    document.getElementById('deleteTeamMessage').textContent =
                        'Delete team "' +
                        (name || 'this team') +
                        '"? Team members will be detached from this team.';
                ...
                document.getElementById('teamModalClose')
                    .addEventListener(
                        'click',
                        closeTeamModal
                    );
                ...
                document.getElementById('teamsToastClose')
                    .addEventListener(
                        'click',
                        function(){
                            toast.classList.remove('show');
                ...
                document.getElementById('clearFiltersButton')
                    .addEventListener(
                        'click',
                        function(){
                            document.getElementById('teamsSearch').value = '';
