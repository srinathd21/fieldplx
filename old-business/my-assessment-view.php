...
$pageTitle = 'My Assessment Details';
$activePage = 'my-jobs';
...
<head>
    ...
    <title>My Assessment Details - FieldPlx</title>
...
a,a:link,a:visited,a:hover,a:focus,a:active{text-decoration:none!important}.mjv-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;margin-bottom:15px}.mjv-title{margin:0 0 5px;color:#0b1933;font-size:21px;font-weight:700}.mjv-sub{margin:0;color:#6f7b90;font-size:10px}.mjv-back{min-height:37px;padding:0 11px;display:inline-flex;align-items:center;gap:6px;border:1px solid #dfe5ec;border-radius:8px;color:#43546c;background:#fff;font-size:9px;font-weight:700}.mjv-grid{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(280px,.7fr);gap:14px}.mjv-card{padding:0;overflow:hidden}.mjv-card-head{padding:12px 14px;border-bottom:1px solid #e7ecf1;background:#fbfcfd}.mjv-card-head h3{margin:0;color:#23344d;font-size:11px}.mjv-body{padding:14px}.mjv-job-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.mjv-number{display:block;margin-bottom:5px;color:#123d70;font-size:9px;font-weight:700}.mjv-job-title{margin:0;color:#14233b;font-size:16px;font-weight:700}.mjv-badge{padding:4px 7px;border-radius:5px;color:#123d70;background:#edf2f7;font-size:8px;font-weight:700;text-transform:capitalize}.mjv-desc{margin:12px 0 0;color:#5f6f83;font-size:9.5px;line-height:1.65;white-space:pre-wrap}.mjv-info{margin-top:14px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.mjv-info-item{padding:10px;border:1px solid #edf1f4;border-radius:8px;background:#fcfdfd}.mjv-info-item small{display:block;margin-bottom:4px;color:#8a96a7;font-size:7.5px;text-transform:uppercase}.mjv-info-item strong{display:block;color:#3b4e66;font-size:9.5px;line-height:1.45}.mjv-section{margin-top:14px;padding-top:13px;border-top:1px solid #edf1f4}.mjv-section-title{margin:0 0 9px;color:#334760;font-size:9px;font-weight:700;text-transform:uppercase}.mjv-person{padding:10px;display:flex;align-items:center;gap:9px;border:1px solid #edf1f4;border-radius:8px;background:#fff}.mjv-person-icon{width:32px;height:32px;display:grid;place-items:center;border-radius:8px;color:#5d971b;background:#f0f8e5}.mjv-person strong,.mjv-person small{display:block}.mjv-person strong{color:#253750;font-size:9.5px}.mjv-person small{margin-top:2px;color:#8490a2;font-size:8px}.mjv-side-list{display:grid;gap:9px}.mjv-side-row{padding:10px 11px;border:1px solid #edf1f4;border-radius:8px;background:#fff}.mjv-side-row small{display:block;margin-bottom:4px;color:#8d98a7;font-size:7.5px;text-transform:uppercase}.mjv-side-row strong{display:block;color:#354961;font-size:9.5px;line-height:1.45}.mjv-empty{padding:38px 20px;text-align:center;color:#8290a3}.mjv-empty i{display:block;margin-bottom:10px;font-size:28px}.mjv-toast{width:min(300px,calc(100vw - 24px));position:fixed;top:82px;right:16px;z-index:25000;padding:8px 9px;border-radius:7px;color:#fff;background:#e45b66;box-shadow:0 10px 26px rgba(0,17,49,.18);opacity:0;transform:translateY(-8px);transition:.18s}.mjv-toast.show{opacity:1;transform:translateY(0)}
@media(max-width:900px){.mjv-grid{grid-template-columns:1fr}}@media(max-width:575px){.mjv-head{flex-direction:column}.mjv-back{width:100%;justify-content:center}.mjv-info{grid-template-columns:1fr}.mjv-toast{left:12px;right:12px;width:auto}}


/* Assessment reschedule / remarks */
.mjv-head-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap}
.mjv-reschedule-btn{min-height:37px;padding:0 12px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid var(--fd-green);border-radius:8px;color:#fff!important;background:linear-gradient(90deg,#7fc92d,#68aa1d);font-size:9px;font-weight:700;cursor:pointer;box-shadow:0 6px 15px rgba(104,170,29,.14)}
.mjv-reschedule-btn:hover{color:#fff!important;background:linear-gradient(90deg,#74b824,#5d971b)}
.mjv-history{display:grid;gap:8px}
.mjv-history-row{padding:10px 11px;border:1px solid #edf1f4;border-radius:8px;background:#fbfcfd}
.mjv-history-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}
.mjv-history-top strong{color:#2b3e57;font-size:9px}.mjv-history-top span{color:#8a96a7;font-size:7.8px;white-space:nowrap}
.mjv-history-date{margin-top:6px;color:#51657e;font-size:8.5px;line-height:1.5}.mjv-history-remark{margin-top:6px;padding-top:6px;border-top:1px solid #eef2f5;color:#5f6f83;font-size:8.5px;line-height:1.55;white-space:pre-wrap}
.mjv-history-empty{padding:14px;border:1px dashed #dfe5ec;border-radius:8px;color:#8a96a7;background:#fcfdfd;font-size:8.5px;text-align:center}
.mjv-modal-bg{position:fixed;inset:0;z-index:15000;display:none;align-items:center;justify-content:center;padding:18px;background:rgba(0,17,49,.46);backdrop-filter:blur(3px)}
.mjv-modal-bg.show{display:flex}.mjv-modal{width:min(620px,100%);max-height:calc(100vh - 36px);overflow:auto;border:1px solid #dfe5ec;border-radius:12px;background:#fff;box-shadow:0 24px 65px rgba(0,17,49,.24)}
.mjv-modal-head{padding:12px 14px;display:flex;align-items:center;gap:10px;border-bottom:1px solid var(--fd-border);background:#fbfcfd}.mjv-modal-icon{width:34px;height:34px;display:grid;place-items:center;border-radius:9px;color:var(--fd-green-dark);background:var(--fd-green-soft);font-size:15px}.mjv-modal-copy{min-width:0;flex:1}.mjv-modal-copy h3{margin:0;color:#263950;font-size:12px}.mjv-modal-copy p{margin:3px 0 0;color:#8a96a7;font-size:8.5px;line-height:1.4}.mjv-modal-close{width:30px;height:30px;display:grid;place-items:center;border:0;border-radius:7px;color:#8490a0;background:transparent;cursor:pointer}
.mjv-modal-body{padding:15px}.mjv-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.mjv-field.full{grid-column:1/-1}.mjv-field label{display:block;margin-bottom:6px;color:#42536c;font-size:9px;font-weight:700}.mjv-field label .req{color:#e45b66}.mjv-field input,.mjv-field textarea{width:100%;min-height:40px;padding:8px 10px;border:1px solid #dfe5ec;border-radius:8px;background:#fff;color:#263750;font-size:10px;outline:0}.mjv-field textarea{min-height:110px;resize:vertical}.mjv-field input:focus,.mjv-field textarea:focus{border-color:#a9cf75;box-shadow:0 0 0 3px rgba(116,184,36,.11)}.mjv-current-schedule{grid-column:1/-1;padding:10px 11px;border:1px solid #e6ebf0;border-radius:8px;color:#52627a;background:#fbfcfd;font-size:8.5px}.mjv-current-schedule strong{color:#263950}
.mjv-modal-foot{padding:12px 15px;display:flex;justify-content:flex-end;gap:8px;border-top:1px solid var(--fd-border);background:#fbfcfd}.mjv-modal-btn{min-height:38px;padding:0 12px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid #dfe5ec;border-radius:8px;color:#43546c;background:#fff;font-size:9px;font-weight:700;cursor:pointer}.mjv-modal-btn.primary{border-color:var(--fd-green);color:#fff;background:linear-gradient(90deg,#7fc92d,#68aa1d)}.mjv-modal-btn:disabled{opacity:.55;cursor:not-allowed}
@media(max-width:575px){.mjv-head-actions{width:100%;display:grid;grid-template-columns:1fr 1fr}.mjv-reschedule-btn,.mjv-head-actions .mjv-back{width:100%;justify-content:center}.mjv-form-grid{grid-template-columns:1fr}.mjv-field.full,.mjv-current-schedule{grid-column:auto}.mjv-modal-foot{flex-direction:column-reverse}.mjv-modal-btn{width:100%}}
...
<section class="mjv-head">
  <div>
    <h1 class="mjv-title">My Assessment Details</h1>
    <p class="mjv-sub">Review the assigned assessment, gather the required site details and reschedule the assessment visit when another visit is required.</p>
  </div>
  <div class="mjv-head-actions">
    <button class="mjv-reschedule-btn" type="button" id="openReschedule" style="display:none"><i class="bi bi-calendar2-week"></i> Reschedule Visit</button>
    <a class="mjv-back" href="my-jobs.php"><i class="bi bi-arrow-left"></i> Back to My Assessments</a>
  </div>
</section>
<div class="mjv-grid" id="content"><section class="fd-card mjv-card"><div class="mjv-empty"><i class="bi bi-hourglass-split"></i>Loading assessment details...</div></section></div>
</div>
<div class="mjv-toast" id="toast">Unable to load assessment.</div>

<div class="mjv-modal-bg" id="rescheduleModal" aria-hidden="true">
  <div class="mjv-modal" role="dialog" aria-modal="true" aria-labelledby="rescheduleTitle">
    <div class="mjv-modal-head">
      <div class="mjv-modal-icon"><i class="bi bi-calendar2-week"></i></div>
      <div class="mjv-modal-copy"><h3 id="rescheduleTitle">Reschedule Assessment Visit</h3><p>Choose the next visit schedule and record the complete reason / assessment remarks. Every reschedule is kept in history.</p></div>
      <button class="mjv-modal-close" type="button" id="closeReschedule"><i class="bi bi-x-lg"></i></button>
    </div>
    <form id="rescheduleForm">
      <div class="mjv-modal-body">
        <div class="mjv-form-grid">
          <div class="mjv-current-schedule" id="currentSchedule">Current schedule: <strong>-</strong></div>
          <div class="mjv-field"><label>New Visit Date <span class="req">*</span></label><input type="date" name="new_date" id="newDate" required></div>
          <div class="mjv-field"><label>From Time</label><input type="time" name="new_time_from" id="newTimeFrom"></div>
          <div class="mjv-field"><label>To Time</label><input type="time" name="new_time_to" id="newTimeTo"></div>
          <div class="mjv-field full"><label>Assessment / Reschedule Remarks <span class="req">*</span></label><textarea name="remarks" id="rescheduleRemarks" maxlength="2000" required placeholder="Enter all gathered assessment details, customer discussion, site condition, pending requirement and reason for the next visit..."></textarea></div>
        </div>
      </div>
      <div class="mjv-modal-foot">
        <button class="mjv-modal-btn" type="button" id="cancelReschedule">Cancel</button>
        <button class="mjv-modal-btn primary" type="submit" id="saveReschedule"><i class="bi bi-check2-circle"></i> Save Reschedule</button>
      </div>
    </form>
  </div>
</div>
...
(function(){
'use strict';
var requestId=<?= (int)$jobId ?>,csrfToken=<?= json_encode($myJobsCsrfToken) ?>;
var content=document.getElementById('content'),toast=document.getElementById('toast'),openBtn=document.getElementById('openReschedule');
var modal=document.getElementById('rescheduleModal'),form=document.getElementById('rescheduleForm'),saveBtn=document.getElementById('saveReschedule');
...
function fmtDateTime(d,from,to){var out=fmt(d);if(from)out+=' · '+String(from).slice(0,5);if(to)out+=' - '+String(to).slice(0,5);return out}
function notify(m,type){toast.textContent=m||'Notification';toast.style.background=type==='success'?'#5d971b':type==='warning'?'#96a52f':'#e45b66';toast.classList.add('show');setTimeout(function(){toast.classList.remove('show')},3000)}
...
function post(action,extra){var fd=new FormData();fd.append('action',action);fd.append('request_id',requestId);fd.append('csrf_token',csrfToken);Object.keys(extra||{}).forEach(function(k){fd.append(k,extra[k])});return fetch('api/my-jobs.php',{method:'POST',body:fd,credentials:'same-origin',headers:{'X-Requested-With':'XMLHttpRequest','Accept':'application/json'}}).then(parse)}
function fail(m){notify(m,'error');content.innerHTML='<section class="fd-card mjv-card"><div class="mjv-empty"><i class="bi bi-exclamation-circle"></i>'+esc(m)+'</div></section>'}
function historyHtml(rows){if(!rows||!rows.length)return '<div class="mjv-history-empty">No reschedule history yet.</div>';var h='<div class="mjv-history">';rows.forEach(function(x){h+='<div class="mjv-history-row"><div class="mjv-history-top"><strong>'+esc(x.rescheduled_by_name||'Service Man')+'</strong><span>'+esc(fmt(x.created_at))+'</span></div><div class="mjv-history-date"><strong>Previous:</strong> '+esc(fmtDateTime(x.old_preferred_date,x.old_time_from,x.old_time_to))+'<br><strong>New Visit:</strong> '+esc(fmtDateTime(x.new_preferred_date,x.new_time_from,x.new_time_to))+'</div><div class="mjv-history-remark">'+esc(x.remarks||'-')+'</div><div style="margin-top:8px"><a class="mjv-back" style="min-height:32px" href="add-quotation.php?request_id='+encodeURIComponent(requestId)+'&revisit_id='+encodeURIComponent(x.id)+'"><i class="bi bi-receipt"></i> Create Revisit Quotation</a></div></div>'});return h+'</div>'}
function render(d){var r=d.request||{},a=d.assignment||{},hist=d.reschedule_history||[];currentRequest=r;var address=[r.address_line1,r.address_line2,r.city,r.state,r.postal_code].filter(Boolean).join(', ');content.innerHTML='<section class="fd-card mjv-card"><div class="mjv-card-head"><h3>Assessment Information</h3></div><div class="mjv-body"><div class="mjv-job-top"><div><span class="mjv-number">'+esc(r.request_no||r.job_no)+'</span><h2 class="mjv-job-title">'+esc(r.title)+'</h2></div><span class="mjv-badge">'+esc(title(r.status))+'</span></div><div class="mjv-desc">'+esc(r.description||'No assessment description added.')+'</div><div class="mjv-info"><div class="mjv-info-item"><small>Customer</small><strong>'+esc(r.client_name||'-')+'</strong></div><div class="mjv-info-item"><small>Service Location</small><strong>'+esc(r.location_name||'-')+(address?'<br>'+esc(address):'')+'</strong></div><div class="mjv-info-item"><small>Service</small><strong>'+esc(r.service_name||'-')+'</strong></div><div class="mjv-info-item"><small>Current Visit Date</small><strong>'+esc(fmtDateTime(r.start_date,r.preferred_time_from,r.preferred_time_to))+'</strong></div><div class="mjv-info-item"><small>Priority</small><strong>'+esc(title(r.priority))+'</strong></div><div class="mjv-info-item"><small>Assessment Type</small><strong>Site Assessment</strong></div></div><div class="mjv-section"><h4 class="mjv-section-title">Your Assignment</h4><div class="mjv-person"><span class="mjv-person-icon"><i class="bi bi-person-check"></i></span><div><strong>'+esc(a.label||'Assigned')+'</strong><small>'+esc(a.role||'Inspector')+' · '+esc(title(a.assignment_status||'assigned'))+'</small></div></div></div><div class="mjv-section"><h4 class="mjv-section-title">Visit Reschedule & Remarks History</h4>'+historyHtml(hist)+'</div></div></section><aside class="fd-card mjv-card"><div class="mjv-card-head"><h3>Linked Details</h3></div><div class="mjv-body mjv-side-list"><div class="mjv-side-row"><small>Request</small><strong>'+esc(r.request_no||'-')+'</strong></div><div class="mjv-side-row"><small>Branch</small><strong>'+esc(r.branch_name||'-')+'</strong></div><div class="mjv-side-row"><small>Customer Phone</small><strong>'+esc(r.client_phone||'-')+'</strong></div><div class="mjv-side-row"><small>Current Schedule</small><strong>'+esc(fmtDateTime(r.start_date,r.preferred_time_from,r.preferred_time_to))+'</strong></div><div class="mjv-side-row"><small>Total Reschedules</small><strong>'+hist.length+'</strong></div></div></aside>';openBtn.style.display='inline-flex'}
function load(){post('get_assessment',{}).then(render).catch(function(e){fail(e.message)})}
function openModal(){if(!currentRequest)return;document.getElementById('currentSchedule').innerHTML='Current schedule: <strong>'+esc(fmtDateTime(currentRequest.start_date,currentRequest.preferred_time_from,currentRequest.preferred_time_to))+'</strong>';document.getElementById('newDate').value=currentRequest.start_date||'';document.getElementById('newTimeFrom').value=(currentRequest.preferred_time_from||'').slice(0,5);document.getElementById('newTimeTo').value=(currentRequest.preferred_time_to||'').slice(0,5);document.getElementById('rescheduleRemarks').value='';modal.classList.add('show');modal.setAttribute('aria-hidden','false');setTimeout(function(){document.getElementById('newDate').focus()},60)}
function closeModal(){modal.classList.remove('show');modal.setAttribute('aria-hidden','true')}
openBtn.addEventListener('click',openModal);document.getElementById('closeReschedule').onclick=closeModal;document.getElementById('cancelReschedule').onclick=closeModal;modal.addEventListener('click',function(e){if(e.target===modal)closeModal()});
form.addEventListener('submit',function(e){e.preventDefault();if(!form.reportValidity()){notify('Enter the new visit date and complete remarks.','warning');return}var nd=document.getElementById('newDate').value,nf=document.getElementById('newTimeFrom').value,nt=document.getElementById('newTimeTo').value,rm=document.getElementById('rescheduleRemarks').value.trim();if(nf&&nt&&nt<=nf){notify('To Time must be after From Time.','warning');return}saveBtn.disabled=true;post('reschedule_assessment',{new_date:nd,new_time_from:nf,new_time_to:nt,remarks:rm}).then(function(d){notify(d.message||'Assessment visit rescheduled successfully.','success');closeModal();load()}).catch(function(er){notify(er.message,'error')}).then(function(){saveBtn.disabled=false},function(){saveBtn.disabled=false})});
if(requestId<=0){fail('Invalid assessment request.')}else{load()}
})();
</script>
            </div>
        </main>
