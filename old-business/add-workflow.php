...
<head>
    ...
    <title>Add Workflow - FieldPlx</title>
...
<main class="fieldplx-main-content"><div class="fieldplx-content-wrapper"><div class="fd-dashboard"><section class="wf-head"><div><h1>Add Workflow</h1><p>Select the service first, then build the exact prebuilt technician process for that service.</p></div><div class="wf-actions"><a class="wf-btn" href="workflows.php"><i class="bi bi-arrow-left"></i> Back to Workflows</a></div></section>
