...
.fd-client-location-link{min-width:42px;height:28px;padding:0 8px;display:inline-flex;align-items:center;justify-content:center;gap:5px;border:1px solid #dfe7ef;border-radius:7px;color:#123d70!important;background:#f8fafc;font-size:9px;font-weight:700;text-decoration:none!important}
.fd-client-location-link:hover{border-color:#cfe3ae;color:var(--fd-green-dark)!important;background:var(--fd-green-soft)}
.fd-team-actions-cell a.fd-team-icon-button{text-decoration:none!important}

/* Separate Add/Edit Client page */
a,a:link,a:visited,a:hover,a:focus,a:active{text-decoration:none!important}
.fd-client-form-header{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;margin-bottom:18px}.fd-client-form-header h1{margin:0 0 7px;color:var(--fd-text);font-size:21px;font-weight:700}.fd-client-form-header p{margin:0;color:var(--fd-muted);font-size:11px;line-height:1.5}.fd-client-form-actions{display:flex;gap:8px;flex-wrap:wrap}.fd-client-form-card{overflow:hidden}.fd-client-form-card-head{padding:13px 15px;border-bottom:1px solid var(--fd-border);background:#fbfcfd}.fd-client-form-card-head strong{display:block;color:#233750;font-size:11px}.fd-client-form-card-head small{display:block;margin-top:3px;color:#8490a2;font-size:8.5px}.fd-client-form-body{padding:17px}.fd-client-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px}.fd-client-form-field.full{grid-column:1/-1}.fd-client-form-section{grid-column:1/-1;padding:9px 0 4px;border-bottom:1px solid #eef2f5;color:#31425b;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.04em}.fd-client-form-field label{display:block;margin-bottom:6px;color:#42536c;font-size:9px;font-weight:700}.fd-client-form-field input,.fd-client-form-field select,.fd-client-form-field textarea{width:100%;min-height:40px;padding:8px 10px;border:1px solid #dfe5ec;border-radius:8px;outline:0;color:#263750;background:#fff;font-size:10px}.fd-client-form-field textarea{min-height:90px;resize:vertical}.fd-client-form-field input:focus,.fd-client-form-field select:focus,.fd-client-form-field textarea:focus{border-color:#a9cf75;box-shadow:0 0 0 3px rgba(116,184,36,.11)}.fd-client-form-help{display:block;margin-top:5px;color:#8b97a8;font-size:8px;line-height:1.45}.fd-client-login-box{grid-column:1/-1;padding:13px;border:1px solid #dfe8cf;border-radius:9px;background:#fbfef7}.fd-client-login-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:10px}.fd-client-login-head strong{display:block;color:#243950;font-size:10px}.fd-client-login-head small{display:block;margin-top:3px;color:#7b899b;font-size:8px}.fd-client-switch{display:flex;align-items:center;gap:7px;color:#42536c;font-size:8.5px;font-weight:700}.fd-client-switch input{width:15px;height:15px;accent-color:var(--fd-green)}.fd-client-form-checks{grid-column:1/-1;display:flex;gap:16px;flex-wrap:wrap}.fd-client-form-checks label{display:flex;align-items:center;gap:7px;color:#53647a;font-size:8.5px}.fd-client-form-checks input{width:14px;height:14px;accent-color:var(--fd-green)}.fd-password-wrap{position:relative}.fd-password-wrap input{padding-right:38px}.fd-password-toggle{width:34px;height:34px;position:absolute;right:3px;top:3px;border:0;border-radius:6px;color:#758298;background:transparent}.fd-password-toggle:hover{color:var(--fd-green-dark);background:var(--fd-green-soft)}.fd-client-form-footer{padding:12px 15px;display:flex;justify-content:flex-end;gap:8px;border-top:1px solid var(--fd-border);background:#fbfcfd}.fd-client-mail-note{grid-column:1/-1;padding:10px 11px;border:1px solid #e2e8ef;border-radius:8px;color:#607087;background:#f8fafc;font-size:8.5px;line-height:1.5}.fd-client-mail-note i{color:var(--fd-green-dark);margin-right:5px}.fd-client-form-toast{width:min(310px,calc(100vw - 24px));position:fixed;top:82px;right:16px;z-index:25000;padding:9px 10px;display:flex;align-items:center;gap:7px;border-radius:7px;color:#fff;opacity:0;transform:translateY(-8px);pointer-events:none;transition:.18s;box-shadow:0 10px 26px rgba(0,17,49,.18)}.fd-client-form-toast.show{opacity:1;transform:translateY(0)}.fd-client-form-toast.success{background:#5d971b}.fd-client-form-toast.error{background:#e45b66}.fd-client-form-toast.warning{background:#9a7a22}.fd-client-form-toast span{flex:1;font-size:8.5px;font-weight:600}.fd-client-form-toast button{border:0;color:#fff;background:transparent}.fd-client-save-loader{width:13px;height:13px;display:none;border:2px dotted currentColor;border-radius:50%;animation:clientSaveSpin .75s linear infinite}.fd-team-button.loading .fd-client-save-loader{display:inline-block}@keyframes clientSaveSpin{to{transform:rotate(360deg)}}
@media(max-width:767.98px){.fd-client-form-header{flex-direction:column}.fd-client-form-grid{grid-template-columns:1fr}.fd-client-form-field.full,.fd-client-form-section,.fd-client-login-box,.fd-client-form-checks,.fd-client-mail-note{grid-column:auto}.fd-client-form-actions{width:100%}.fd-client-form-actions .fd-team-button{flex:1}.fd-client-form-footer{flex-direction:column-reverse}.fd-client-form-footer .fd-team-button{width:100%}}@media(max-width:575.98px){.fd-client-form-toast{top:72px;left:12px;right:12px;width:auto}}
...
<main class="fieldplx-main-content"><div class="fieldplx-content-wrapper"><div class="fd-dashboard">
<section class="fd-client-form-header"><div><h1 id="pageHeading">Add Client</h1><p id="pageSubtitle">Create the client profile and customer portal login credentials in one page.</p></div><div class="fd-client-form-actions"><a class="fd-team-button" href="clients.php"><i class="bi bi-arrow-left"></i> Back to Clients</a></div></section>
<form id="clientForm" class="fd-card fd-client-form-card" autocomplete="off">
<div class="fd-client-form-card-head"><strong id="cardHeading">Client Information</strong><small>Add and edit use this same page. Edit mode is loaded automatically from the client_id URL.</small></div>
<div class="fd-client-form-body"><input type="hidden" id="clientId" name="client_id" value="0"><div class="fd-client-form-grid">
<div class="fd-client-form-section">Client Identity</div>
<div class="fd-client-form-field"><label>Client Type</label><select id="clientType" name="client_type"><option value="lead">Lead</option><option value="client">Client</option><option value="archived">Archived</option></select></div>
<div class="fd-client-form-field"><label>Status</label><select id="clientStatus" name="status"><option value="new">New</option><option value="active">Active</option><option value="inactive">Inactive</option><option value="archived">Archived</option></select></div>
<div class="fd-client-form-field"><label>Display Name *</label><input type="text" id="displayName" name="display_name" maxlength="190" required></div>
<div class="fd-client-form-field"><label>Company Name</label><input type="text" id="companyName" name="company_name" maxlength="190"></div>
<div class="fd-client-form-field"><label>First Name</label><input type="text" id="firstName" name="first_name" maxlength="120"></div>
<div class="fd-client-form-field"><label>Last Name</label><input type="text" id="lastName" name="last_name" maxlength="120"></div>
<div class="fd-client-form-section">Contact & Ownership</div>
<div class="fd-client-form-field"><label>Email</label><input type="email" id="email" name="email" maxlength="190"><small class="fd-client-form-help">Used as a customer portal login identifier and for account emails.</small></div>
<div class="fd-client-form-field"><label>Contact Number</label><input type="text" id="phone" name="phone" maxlength="50"><small class="fd-client-form-help">Customer can also login using this contact number.</small></div>
<div class="fd-client-form-field"><label>Alternate Phone</label><input type="text" id="alternatePhone" name="alternate_phone" maxlength="50"></div>
<div class="fd-client-form-field"><label>Source</label><input type="text" id="source" name="source" maxlength="120" placeholder="Website / Referral / Walk-in"></div>
<div class="fd-client-form-field"><label>Branch</label><select id="branchId" name="branch_id"><option value="">No Branch</option></select></div>
<div class="fd-client-form-field"><label>Account Manager</label><select id="accountManagerId" name="account_manager_id"><option value="">No Account Manager</option></select></div>
<div class="fd-client-form-field"><label>Preferred Contact</label><select id="preferredContactMethod" name="preferred_contact_method"><option value="email">Email</option><option value="sms">SMS</option><option value="phone">Phone</option><option value="whatsapp">WhatsApp</option><option value="none">None</option></select></div>
<div class="fd-client-form-field"><label>Tax Number</label><input type="text" id="taxNumber" name="tax_number" maxlength="100"></div>
<div class="fd-client-form-checks"><label><input type="checkbox" id="allowEmail" name="allow_email" value="1" checked> Allow Email</label><label><input type="checkbox" id="allowSms" name="allow_sms" value="1" checked> Allow SMS</label></div>
<div class="fd-client-form-section">Customer Portal Login</div>
<div class="fd-client-login-box"><div class="fd-client-login-head"><div><strong>Email / Contact + Password Login</strong><small>The customer can login using the Email or Contact Number entered above.</small></div><label class="fd-client-switch"><input type="checkbox" id="portalEnabled" name="portal_enabled" value="1" checked> Enable Login</label></div><div class="fd-client-form-grid">
<div class="fd-client-form-field"><label id="passwordLabel">Customer Password *</label><div class="fd-password-wrap"><input type="password" id="customerPassword" name="customer_password" minlength="8" maxlength="72" autocomplete="new-password"><button class="fd-password-toggle" type="button" data-target="customerPassword"><i class="bi bi-eye"></i></button></div><small class="fd-client-form-help" id="passwordHelp">Minimum 8 characters.</small></div>
<div class="fd-client-form-field"><label>Confirm Password</label><div class="fd-password-wrap"><input type="password" id="confirmPassword" name="confirm_password" minlength="8" maxlength="72" autocomplete="new-password"><button class="fd-password-toggle" type="button" data-target="confirmPassword"><i class="bi bi-eye"></i></button></div></div>
</div></div>
<div class="fd-client-mail-note"><i class="bi bi-envelope-check"></i>After create/update, FieldPlx will send an account email through the active Tenant/Branch SMTP configuration when the client has an email address. The password is included only when a new password is created or changed.</div>
<div class="fd-client-form-section">Internal Notes</div><div class="fd-client-form-field full"><label>Notes</label><textarea id="notes" name="notes" maxlength="5000"></textarea></div>
</div></div>
<div class="fd-client-form-footer"><a class="fd-team-button" href="clients.php">Cancel</a><button type="submit" class="fd-team-button primary" id="saveClientButton"><span class="fd-client-save-loader"></span><i class="bi bi-check-lg"></i><span id="saveClientText">Create Client</span></button></div>
</form>
</div></div></main></div>
<?php require_once __DIR__ . '/includes/footer.php'; ?>
<div class="fd-client-form-toast" id="clientToast"><span id="clientToastMessage">Notification</span><button type="button" id="clientToastClose"><i class="bi bi-x"></i></button></div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script>
(function(){'use strict';
var csrfToken=<?= json_encode($clientsCsrfToken) ?>;var params=new URLSearchParams(location.search);var clientId=Number(params.get('client_id')||0);var editMode=clientId>0;var form=document.getElementById('clientForm'),saveButton=document.getElementById('saveClientButton'),toast=document.getElementById('clientToast'),toastMsg=document.getElementById('clientToastMessage'),toastTimer=null,dirty=false,submitting=false,initializing=true;
...
function applyMeta(meta){var bh='<option value="">No Branch</option>',mh='<option value="">No Account Manager</option>';(meta.branches||[]).forEach(function(x){bh+='<option value="'+Number(x.id)+'">'+esc(x.name)+'</option>'});(meta.users||[]).forEach(function(x){mh+='<option value="'+Number(x.id)+'">'+esc(x.name)+'</option>'});document.getElementById('branchId').innerHTML=bh;document.getElementById('accountManagerId').innerHTML=mh}
function updateMode(){document.getElementById('pageHeading').textContent=editMode?'Edit Client':'Add Client';document.getElementById('pageSubtitle').textContent=editMode?'Update the client profile and customer portal login in the same page.':'Create the client profile and customer portal login credentials in one page.';document.getElementById('saveClientText').textContent=editMode?'Update Client':'Create Client';document.getElementById('passwordLabel').textContent=editMode?'New Customer Password':'Customer Password *';document.getElementById('passwordHelp').textContent=editMode?'Leave blank to keep the existing password. Enter a new password only when changing it.':'Minimum 8 characters.';document.getElementById('customerPassword').required=!editMode&&document.getElementById('portalEnabled').checked;document.getElementById('confirmPassword').required=!editMode&&document.getElementById('portalEnabled').checked}
function load(){var fd=new FormData();fd.append('action',editMode?'get':'meta');if(editMode)fd.append('client_id',clientId);request(fd).then(function(d){applyMeta(d.meta||{});if(editMode){var r=d.client||{},p=d.portal||{};document.getElementById('clientId').value=r.id||clientId;document.getElementById('clientType').value=r.client_type||'lead';document.getElementById('clientStatus').value=r.status||'new';document.getElementById('displayName').value=r.display_name||'';document.getElementById('companyName').value=r.company_name||'';document.getElementById('firstName').value=r.first_name||'';document.getElementById('lastName').value=r.last_name||'';document.getElementById('email').value=r.email||'';document.getElementById('phone').value=r.phone||'';document.getElementById('alternatePhone').value=r.alternate_phone||'';document.getElementById('source').value=r.source||'';document.getElementById('branchId').value=r.branch_id||'';document.getElementById('accountManagerId').value=r.account_manager_id||'';document.getElementById('preferredContactMethod').value=r.preferred_contact_method||'email';document.getElementById('taxNumber').value=r.tax_number||'';document.getElementById('allowEmail').checked=Number(r.allow_email)===1;document.getElementById('allowSms').checked=Number(r.allow_sms)===1;document.getElementById('notes').value=r.notes||'';document.getElementById('portalEnabled').checked=p.exists?String(p.status)!=='inactive':true;}initializing=false;dirty=false;updateMode()}).catch(function(e){initializing=false;showToast('error',e.message);saveButton.disabled=true})}
