<?php
/* FieldPlx Products - Canonical Customers Template - Version 1.4.0 - 2026-08-28 */
      ...
      <div class="fieldplx-content-wrapper">
        <div class="fd-dashboard">
          <section class="fd-teams-header">
            <div>
              <h1 class="fd-teams-title">Products</h1>
              <p class="fd-teams-subtitle">Manage product master details, base pricing, markup, selling price and tax used across quotations, jobs and invoices.</p>
            </div>
            <div class="fd-teams-actions">
              <button type="button" class="fd-team-button" id="refreshBtn"><i class="bi bi-arrow-clockwise"></i> Refresh</button>
          ...
          <section class="row g-3 fd-teams-summary">
            <div class="col-xl-3 col-md-6">
              <article class="fd-team-stat-card">
                <div class="fd-team-stat-row"><span class="fd-team-stat-icon"><i class="bi bi-box-seam"></i></span>
                  <div><span class="fd-team-stat-label">Total Products</span><strong class="fd-team-stat-value" id="summaryTotal">0</strong></div>
                </div>
              </article>
            </div>
            <div class="col-xl-3 col-md-6">
              <article class="fd-team-stat-card">
                <div class="fd-team-stat-row"><span class="fd-team-stat-icon"><i class="bi bi-check2-circle"></i></span>
                  <div><span class="fd-team-stat-label">Active Products</span><strong class="fd-team-stat-value" id="summaryActive">0</strong></div>
                </div>
              </article>
            </div>
            <div class="col-xl-3 col-md-6">
              <article class="fd-team-stat-card">
                <div class="fd-team-stat-row"><span class="fd-team-stat-icon"><i class="bi bi-pause-circle"></i></span>
                  <div><span class="fd-team-stat-label">Inactive Products</span><strong class="fd-team-stat-value" id="summaryInactive">0</strong></div>
                </div>
              </article>
            </div>
            <div class="col-xl-3 col-md-6">
              <article class="fd-team-stat-card">
                <div class="fd-team-stat-row"><span class="fd-team-stat-icon"><i class="bi bi-archive"></i></span>
                  <div><span class="fd-team-stat-label">Archived Products</span><strong class="fd-team-stat-value" id="summaryArchived">0</strong></div>
                </div>
              </article>
            </div>
          </section>
        ...
        <script>
          (function () {
            ...
            function render(data){
              ...
              var s=data.summary||{},pg=data.pagination||{};
              el('summaryTotal').textContent=Number(s.total||0);
              el('summaryActive').textContent=Number(s.active||0);
              el('summaryInactive').textContent=Number(s.inactive||0);
              el('summaryArchived').textContent=Number(s.archived||0);
            ...
            el('refreshBtn').onclick=loadProducts;
            ...
            el('confirmArchiveBtn').onclick=function(){if(!archiveId)return;var b=this;loading(b,true);request({action:'archive',id:archiveId}).then(function(d){closeArchive();notify('success',d.message);loadProducts();}).catch(function(e){notify('error',e.message);}).finally(function(){loading(b,false);});};
