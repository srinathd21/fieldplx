...
/* ==========================================================
   My Jobs - technician/service employee table view
   ========================================================== */
a,a:link,a:visited,a:hover,a:focus,a:active{text-decoration:none!important}
.mj-page-head{display:flex;align-items:flex-start;justify-content:space-between;gap:15px;margin-bottom:16px}.mj-title{margin:0 0 5px;color:var(--fd-text,#0b1933);font-size:21px;font-weight:700}.mj-sub{margin:0;max-width:850px;color:var(--fd-muted,#6f7b90);font-size:10.5px;line-height:1.55}.mj-refresh{min-height:38px;padding:0 12px;display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid var(--fd-border,#e5eaf1);border-radius:8px;color:#43546c;background:#fff;font-size:9.5px;font-weight:700;cursor:pointer}.mj-refresh:hover{border-color:#cfe3ae;color:var(--fd-green-dark);background:#f9fcf4}
.mj-summary{margin-bottom:15px}.mj-stat{height:100%;min-height:102px;padding:16px 17px;display:flex;align-items:center;gap:14px;border:1px solid #e3e8ef;border-radius:10px;background:#fff;box-shadow:0 3px 10px rgba(13,34,63,.035)}.mj-stat-icon{width:48px;height:48px;flex:0 0 48px;display:grid;place-items:center;border-radius:12px;color:#fff;background:#123d70;font-size:20px}.mj-stat-label{display:block;margin-bottom:6px;color:#68788f;font-size:10px}.mj-stat-value{display:block;color:#101d33;font-size:26px;line-height:1;font-weight:700}
.mj-card{overflow:hidden}.mj-toolbar{padding:12px 13px;display:flex;align-items:center;gap:8px;flex-wrap:wrap;border-bottom:1px solid #e8edf2;background:#fbfcfd}.mj-search{width:260px;position:relative}.mj-search i{position:absolute;left:11px;top:50%;transform:translateY(-50%);color:#8d98a8;font-size:12px}.mj-search input,.mj-filter,.mj-date{height:38px;border:1px solid #dfe5ec;border-radius:8px;outline:0;color:#34465e;background:#fff;font-size:9.5px}.mj-search input{width:100%;padding:8px 10px 8px 31px}.mj-filter{min-width:135px;padding:7px 9px}.mj-date-wrap{display:flex;align-items:center;gap:6px}.mj-date{width:132px;padding:7px 9px}.mj-date-label{color:#7a8798;font-size:8px;font-weight:700;white-space:nowrap}.mj-clear{height:38px;padding:0 11px;border:1px solid #dfe5ec;border-radius:8px;color:#5c6d84;background:#fff;font-size:9px;font-weight:700;cursor:pointer}.mj-clear:hover{border-color:#cfe3ae;color:var(--fd-green-dark);background:#f9fcf4}
.mj-table-wrap{width:100%;overflow-x:auto;overflow-y:hidden;scrollbar-width:thin;scrollbar-color:#9aa0a6 transparent}.mj-table-wrap::-webkit-scrollbar{height:3px!important}.mj-table-wrap::-webkit-scrollbar-track{background:transparent!important}.mj-table-wrap::-webkit-scrollbar-thumb{min-width:20px;border-radius:999px!important;background:#9aa0a6!important}.mj-table-wrap::-webkit-scrollbar-button{display:none!important;width:0!important;height:0!important}.mj-table{width:100%;min-width:1380px;border-collapse:collapse;white-space:nowrap}.mj-table th{padding:11px 12px;border-bottom:1px solid var(--fd-border,#e5eaf1);color:#65738a;background:#f8fafc;font-size:9px;font-weight:700;text-align:left;text-transform:uppercase}.mj-table td{padding:12px;border-bottom:1px solid #f1f3f7;color:#33445f;font-size:9.5px;vertical-align:middle}.mj-table th:first-child,.mj-table td:first-child{width:52px;text-align:center}.mj-table tbody tr:hover{background:#fbfcfa}.mj-no{color:#123d70;font-size:9.5px;font-weight:700}.mj-work strong,.mj-work small,.mj-client strong,.mj-client small{display:block}.mj-work strong,.mj-client strong{color:#17233b;font-size:10px}.mj-work small,.mj-client small{margin-top:3px;color:#8995a6;font-size:8.3px;max-width:210px;overflow:hidden;text-overflow:ellipsis}.mj-type{display:inline-flex;align-items:center;gap:5px;padding:4px 7px;border-radius:5px;font-size:8px;font-weight:700}.mj-type.job{color:#123d70;background:#edf2f7}.mj-type.assessment{color:#a85a08;background:#fff1e4}.mj-type.revisit{color:#5b4dad;background:#f1efff}.mj-status{padding:4px 7px;display:inline-flex;border-radius:5px;font-size:7.8px;font-weight:700;text-transform:capitalize}.mj-status.draft,.mj-status.active{color:#123d70;background:#edf2f7}.mj-status.scheduled,.mj-status.upcoming,.mj-status.today,.mj-status.in_progress,.mj-status.rescheduled{color:#96600a;background:#fff4df}.mj-status.waiting_customer,.mj-status.waiting_material,.mj-status.needs_review{color:#805d12;background:#fff8e1}.mj-status.completed,.mj-status.ready_to_invoice,.mj-status.closed{color:#5d971b;background:#f0f8e5}.mj-status.invoiced{color:#5b4dad;background:#f1efff}.mj-status.cancelled,.mj-status.archived{color:#b9424b;background:#fff0f1}.mj-status.assessment_required{color:#a85a08;background:#fff1e4}.mj-priority{padding:4px 7px;display:inline-flex;border-radius:5px;font-size:8px;font-weight:700;text-transform:capitalize}.mj-priority.low{color:#5d971b;background:#f0f8e5}.mj-priority.normal{color:#123d70;background:#edf2f7}.mj-priority.high{color:#96600a;background:#fff4df}.mj-priority.urgent{color:#b9424b;background:#fff0f1}.mj-assigned{color:#65758b;font-size:8.5px}.mj-view{width:29px;height:29px;display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:6px;color:#66748b;background:transparent;font-size:12px}.mj-view:hover{color:var(--fd-green-dark);background:var(--fd-green-soft)}.mj-empty-cell{padding:36px 18px!important;text-align:center!important;color:#8793a4!important}.mj-empty-cell i{display:block;margin-bottom:8px;color:#a8b4c2;font-size:26px}.mj-empty-cell strong{display:block;margin-bottom:4px;color:#596b82;font-size:10.5px}.mj-empty-cell span{font-size:8.5px}.mj-loading td{padding:35px 18px!important;text-align:center!important;color:#8793a4!important}
.mj-pager{padding:10px 13px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-top:1px solid #e8edf2;color:#7a8798;background:#fff;font-size:8.5px}.mj-pager-buttons{display:flex;gap:6px}.mj-pager button{width:34px;height:32px;border:1px solid #dfe5ec;border-radius:7px;color:#55667d;background:#fff}.mj-pager button:disabled{opacity:.45}
.mj-toast{width:min(300px,calc(100vw - 24px));position:fixed;top:82px;right:16px;z-index:25000;padding:8px 9px;display:flex;align-items:center;gap:7px;border-radius:7px;color:#fff;box-shadow:0 10px 26px rgba(0,17,49,.18);opacity:0;transform:translateY(-8px);pointer-events:none;transition:.18s}.mj-toast.show{opacity:1;transform:translateY(0)}.mj-toast.error{background:#e45b66}.mj-toast.info{background:#123d70}.mj-toast-msg{flex:1;font-size:8.5px;font-weight:600}
...
<section class="row g-3 mj-summary">
  <div class="col-xl-3 col-6"><article class="mj-stat"><span class="mj-stat-icon"><i class="bi bi-briefcase"></i></span><div><span class="mj-stat-label">Assigned Work</span><strong class="mj-stat-value" id="statTotal">0</strong></div></article></div>
  <div class="col-xl-3 col-6"><article class="mj-stat"><span class="mj-stat-icon"><i class="bi bi-calendar-day"></i></span><div><span class="mj-stat-label">Today</span><strong class="mj-stat-value" id="statToday">0</strong></div></article></div>
  <div class="col-xl-3 col-6"><article class="mj-stat"><span class="mj-stat-icon"><i class="bi bi-play-circle"></i></span><div><span class="mj-stat-label">In Progress</span><strong class="mj-stat-value" id="statProgress">0</strong></div></article></div>
  <div class="col-xl-3 col-6"><article class="mj-stat"><span class="mj-stat-icon"><i class="bi bi-check-circle"></i></span><div><span class="mj-stat-label">Completed</span><strong class="mj-stat-value" id="statCompleted">0</strong></div></article></div>
</section>

<section class="fd-card mj-card">
  <div class="mj-toolbar">
    <div class="mj-search"><i class="bi bi-search"></i><input type="search" id="search" placeholder="Search job, customer, service or location"></div>
    <select class="mj-filter" id="statusFilter"><option value="">All Status</option><option value="assessment_required">Assessment Required</option><option value="today">Today</option><option value="scheduled">Scheduled</option><option value="upcoming">Upcoming</option><option value="active">Active</option><option value="in_progress">In Progress</option><option value="waiting_customer">Waiting Customer</option><option value="waiting_material">Waiting Material</option><option value="rescheduled">Rescheduled</option><option value="completed">Completed</option><option value="needs_review">Needs Review</option><option value="ready_to_invoice">Ready to Invoice</option><option value="invoiced">Invoiced</option><option value="closed">Closed</option></select>
    <select class="mj-filter" id="priorityFilter"><option value="">All Priority</option><option value="low">Low</option><option value="normal">Normal</option><option value="high">High</option><option value="urgent">Urgent</option></select>
    <div class="mj-date-wrap"><span class="mj-date-label">From</span><input class="mj-date" type="date" id="dateFrom"><span class="mj-date-label">To</span><input class="mj-date" type="date" id="dateTo"></div>
...
<div class="mj-toast info" id="toast"><span class="mj-toast-msg" id="toastMsg">Notification</span></div>
...
document.getElementById('priorityFilter').onchange=function(e){state.priority=e.target.value;state.page=1;load()};
document.getElementById('dateFrom').onchange=function(e){state.dateFrom=e.target.value;if(state.dateTo&&state.dateFrom>state.dateTo){document.getElementById('dateTo').value=state.dateFrom;state.dateTo=state.dateFrom}state.page=1;load()};
