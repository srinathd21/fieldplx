<?php
/**
 * FieldPlx - Tasks (Visits UI matched)
...
.tasks-page .task-input,
.tasks-page .task-select {
    width: 100%;
    height: 36px;
    min-height: 36px;
    padding: 8px 10px;
...
.tasks-page .task-input:focus,
.tasks-page .task-select:focus {
    border-color: #8b5cf6;
    box-shadow: 0 0 0 3px rgba(139,92,246,.08);
}

.tasks-page .task-filter-actions {
    display: flex;
    gap: 6px;
}

.tasks-page .task-filter-btn,
.tasks-page .task-reset {
    height: 36px;
    min-height: 36px;
    padding: 0 12px;
    box-sizing: border-box;
