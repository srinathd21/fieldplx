...
<section class="fd-employees-header"><div><h1 class="fd-employees-title">Employees</h1><p class="fd-employees-subtitle">Manage tenant employees, branch and department assignment, roles, field work and account access.</p></div><div class="fd-employees-actions"><button class="fd-employee-btn" id="refreshEmployeesButton" type="button"><i class="bi bi-arrow-clockwise"></i>Refresh</button><button class="fd-employee-btn primary" id="addEmployeeButton" type="button"><i class="bi bi-person-plus"></i>Add Employee</button></div></section>
<section class="row g-3 mb-3"><div class="col-xl-3 col-md-6"><article class="fd-employee-stat"><div class="fd-employee-stat-row"><span class="fd-employee-stat-icon"><i class="bi bi-people"></i></span><div><span class="fd-employee-stat-label">Total Employees</span><strong class="fd-employee-stat-value" id="statTotal">0</strong></div></div></article></div><div class="col-xl-3 col-md-6"><article class="fd-employee-stat"><div class="fd-employee-stat-row"><span class="fd-employee-stat-icon"><i class="bi bi-person-check"></i></span><div><span class="fd-employee-stat-label">Active</span><strong class="fd-employee-stat-value" id="statActive">0</strong></div></div></article></div><div class="col-xl-3 col-md-6"><article class="fd-employee-stat"><div class="fd-employee-stat-row"><span class="fd-employee-stat-icon"><i class="bi bi-geo-alt"></i></span><div><span class="fd-employee-stat-label">Field Workers</span><strong class="fd-employee-stat-value" id="statField">0</strong></div></div></article></div><div class="col-xl-3 col-md-6"><article class="fd-employee-stat"><div class="fd-employee-stat-row"><span class="fd-employee-stat-icon"><i class="bi bi-building"></i></span><div><span class="fd-employee-stat-label">Branches</span><strong class="fd-employee-stat-value" id="statBranches">0</strong></div></div></article></div></section>
